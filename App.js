  ...
  return (
    <View style={styles.container}>
      <ImageBackground
        ...
        resizeMode='cover'>
        <CountySearchDetails countryData={countryData} fetchCountryData={fetchCountryData} fetchWeatherData={fetchWeatherData} />

        <View style={{ display: display }}>
          {looding ? <ActivityIndicator color='gray' size={36} /> : <Weather weatherData={weatherData} />}
        </View>
      </ImageBackground>
    </View>
  );
